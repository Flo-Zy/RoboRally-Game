...
public class ExtraCrispy extends GameBoard {
    public ExtraCrispy() {
        ...
        field3_0.add(new Empty("4A"));

        List<Field> field3_1 = new ArrayList<>();
        field3_1.add(new Empty("4A"));

        List<Field> field3_2 = new ArrayList<>();
        field3_2.add(new Empty("4A"));

        List<Field> field3_3 = new ArrayList<>();
        String[] orientations33Wall = {"bottom"};
        field3_3.add(new Wall("4A", orientations33Wall));
        ...
        field3_6.add(new Wall("4A", orientations36Wall));
        //field3_6.add(new Empty("4A"));

        List<Field> field3_7 = new ArrayList<>();
        field3_7.add(new Empty("4A"));

        List<Field> field3_8 = new ArrayList<>();
        field3_8.add(new Empty("4A"));

        List<Field> field3_9 = new ArrayList<>();
        field3_9.add(new EnergySpace("4A", 1));
        String[] orientations39Wall = {"right"};
        field3_9.add(new Wall("4A", orientations39Wall));
        ...
        field4_0.add(new ConveyorBelt("4A", 2, orientations40));

        List<Field> field4_1 = new ArrayList<>();
        String[] orientations41 = {"bottom", "top"};
        field4_1.add(new ConveyorBelt("4A", 2, orientations41));

        List<Field> field4_2 = new ArrayList<>();
        String[] orientations42 = {"bottom", "top"};
        field4_2.add(new ConveyorBelt("4A", 2, orientations42));

        List<Field> field4_3 = new ArrayList<>();
        String[] orientations43 = {"right", "top"};
        field4_3.add(new ConveyorBelt("4A", 2, orientations43));

        List<Field> field4_4 = new ArrayList<>();
        field4_4.add(new Empty("4A"));

        List<Field> field4_5 = new ArrayList<>();
        field4_5.add(new Empty("4A"));

        List<Field> field4_6 = new ArrayList<>();
        String[] orientations46 = {"right", "bottom"};
        field4_6.add(new ConveyorBelt("4A", 2, orientations46));

        List<Field> field4_7 = new ArrayList<>();
        String[] orientations47 = {"top", "bottom"};
        field4_7.add(new ConveyorBelt("4A", 2, orientations47));

        List<Field> field4_8 = new ArrayList<>();
        String[] orientations48 = {"top", "bottom"};
        field4_8.add(new ConveyorBelt("4A", 2, orientations48));

        List<Field> field4_9 = new ArrayList<>();
        String[] orientations49Wall = {"left"};
        field4_9.add(new Wall("4A", orientations49Wall));
        String[] orientations49Laser = {"right"};
        field4_9.add(new Laser("4A", orientations49Laser, 1));
        ...
        field5_0.add(new Empty("4A"));

        List<Field> field5_1 = new ArrayList<>();
        String[] orientations51Wall = {"bottom"};
        field5_1.add(new Wall("4A", orientations51Wall));

        List<Field> field5_2 = new ArrayList<>();
        field5_2.add(new CheckPoint("4A", 4));
        String[] orientations52Wall = {"top"};
        field5_2.add(new Wall("4A", orientations52Wall));
        String[] orientation52Laser = {"bottom"};
        field5_2.add(new Laser("4A", orientation52Laser, 1));

        List<Field> field5_3 = new ArrayList<>();
        String[] orientations53 = {"right", "left"};
        field5_3.add(new ConveyorBelt("4A", 2, orientations53));
        String[] orientations53Laser = {"top"};
        field5_3.add(new Laser("4A", orientations53Laser,1));

        List<Field> field5_4 = new ArrayList<>();
        String[] orientations54Laser = {"top"};
        field5_4.add(new Laser("4A", orientations54Laser,1));

        List<Field> field5_5 = new ArrayList<>();
        String[] orientations55Laser = {"top"};
        field5_5.add(new Laser("4A", orientations55Laser,1));
        String[] orientations55Wall = {"right"};
        field5_5.add(new Wall("4A", orientations55Wall));

        List<Field> field5_6 = new ArrayList<>();
        String[] orientations56Belt = {"right, left"};
        field5_6.add(new ConveyorBelt("4A", 2, orientations56Belt));
        String[] orientations56Laser = {"top"};
        field5_6.add(new Laser("4A", orientations56Laser,1));

        List<Field> field5_7 = new ArrayList<>();
        field5_7.add(new CheckPoint("4A", 2));
        String[] orientations57Wall = {"bottom"};
        field5_7.add(new Wall("4A", orientations57Wall));
        String[] orientation57Laser = {"top"};
        field5_7.add(new Laser("4A", orientation57Laser, 1));

        List<Field> field5_8 = new ArrayList<>();
        String[] orientations58Wall = {"top"};
        field5_8.add(new Wall("4A", orientations58Wall));

        List<Field> field5_9 = new ArrayList<>();
        String[] orientations59Laser = {"right"};
        field5_9.add(new Laser("4A", orientations59Laser,1));
        ...
        field10_2.add(new CheckPoint("4A", 1));
        String[] orientation102Wall = {"top"};
        field10_2.add(new Wall("4A", orientation102Wall));
        String[] orientation102Laser = {"bottom"};
        field10_2.add(new Laser("4A", orientation102Laser, 1));
        ...
        String[] orientation107Laser = {"top"};
        field10_7.add(new Laser("4A", orientation107Laser, 1));
